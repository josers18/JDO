...
--      after rewriting the FQN from DATA_JEDAIS.FINS__PUBLIC.DNB_BUSINESS_CREDIT to FINS.TEST.*).
...
--      `DATA_JEDAIS.FINS__PUBLIC.V_ACCOUNT_ANCHORS`, `DATA_JEDAIS.FINS__PUBLIC.DNB_BUSINESS_CREDIT`, and
