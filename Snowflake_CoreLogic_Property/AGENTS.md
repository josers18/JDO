...
## Boundaries
- Owns: `DATA_JEDAIS.FINS__PUBLIC.CORELOGIC_PROPERTY`, `SP_GENERATE_CORELOGIC_PROPERTY`, `TASK_QUARTERLY_CORELOGIC_PROPERTY`, and the DC Data Stream / DLO / DMO that federates this table.
