-- =============================================================================
-- FINS.PUBLIC.TASK_QUARTERLY_CORELOGIC_PROPERTY
...
-- Wrapper:  FINS.PUBLIC.SP_RETRY_WRAPPER('FINS.PUBLIC.SP_GENERATE_CORELOGIC_PROPERTY()', 2)
...
CREATE OR REPLACE TASK FINS.PUBLIC.TASK_QUARTERLY_CORELOGIC_PROPERTY
    WAREHOUSE = MAIN_WH_XS
    SCHEDULE  = 'USING CRON 0 8 1 1,4,7,10 * UTC'
AS
    CALL FINS.PUBLIC.SP_RETRY_WRAPPER(
        'FINS.PUBLIC.SP_GENERATE_CORELOGIC_PROPERTY()',
        2
    );

ALTER TASK FINS.PUBLIC.TASK_QUARTERLY_CORELOGIC_PROPERTY RESUME;
