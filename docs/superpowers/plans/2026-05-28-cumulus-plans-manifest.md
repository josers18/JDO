...
| Plan 8 — MGP Financial Plans | **In progress** (T1+T2 deployed: scaffold + table DDL; T3+T4 done: 19 L1 tests green + SP module; T5+T6 authored: L2 SQL test + deploy script + monthly TASK; T7+T8 pending) | `2026-05-28-cumulus-plan-8-mgp-financial-plans.md` |
