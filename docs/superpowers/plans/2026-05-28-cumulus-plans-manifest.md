...
| Plan 9 — Synth Relationship Graph | **In progress** (T1+T2 deployed: scaffold + 9-col DDL; T3-T8 pending) | `2026-05-28-cumulus-plan-9-synth-relationship-graph.md` |
| Plan 10 — BoardEx Exec Intel | **In progress** (T1+T2 deployed: scaffold + 15-col DDL; T3-T8 pending) | `2026-05-28-cumulus-plan-10-boardex-exec-intel.md` |
| Plan 11 — ZoomInfo Firmographics | **In progress** (T1+T2 deployed: scaffold + 15-col DDL; T3-T8 pending) | `2026-05-28-cumulus-plan-11-zoominfo-firmographics.md` |
| Plan 12 — Gong Call Sentiment | **In progress** (T1+T2 deployed: scaffold + 15-col DDL; T3-T8 pending) | `2026-05-28-cumulus-plan-12-gong-call-sentiment.md` |
| Plan 13 — Moody's Market Context | **In progress** (T1+T2 deployed: scaffold + 14-col DDL; T3-T8 pending) | `2026-05-28-cumulus-plan-13-moodys-market-context.md` |
