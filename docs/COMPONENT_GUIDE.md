...
| Markdown Renderer | `c/markdownRenderer` | AgentforceOutput (Lightning Type renderer override; not a record-page palette item) | Any value typed `c__markdownResponse` (markdown OR HTML) — auto-detects format and routes through regex parser or DOMParser-based sanitizer | [DC_AgentForce_Markdown_Renderer/docs/INTEGRATION_GUIDE.md](../DC_AgentForce_Markdown_Renderer/docs/INTEGRATION_GUIDE.md) |
