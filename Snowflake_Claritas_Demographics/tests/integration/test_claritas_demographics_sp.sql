...
--      after rewriting the FQN from DATA_JEDAIS.FINS__PUBLIC.CLARITAS_DEMOGRAPHICS to FINS.TEST.*).
...
--      `DATA_JEDAIS.FINS__PUBLIC.V_ACCOUNT_ANCHORS`, `DATA_JEDAIS.FINS__PUBLIC.CLARITAS_DEMOGRAPHICS`, and
