...
|----------|------|---------|---------|
| **Main card title** | String | `Model prediction` | Main heading above the gauge (e.g. “Attrition Risk”). |
...
| **Gauge subtitle (under score)** | String | `Prediction score` | Short label under the percentage (e.g. “Probability”). |
