...
/** Safe color for CSS custom property (#hex, rgb/rgba only). */
...
export default class ClassificationModelLwc extends LightningElement {
    ...
    /** Optional accent for themed chrome (e.g. FSI presets with obsidian–union themes). */
    @api accentColor = '';
    ...
    /**
     * Optional #hex or rgb()/rgba(). Colors GenAI summary text, section titles (e.g. Top predictors),
     * and row labels. Blank uses theme defaults.
     */
    @api summaryAndLabelTextColor = '';

    /** 80–200. 100 = default GenAI summary font size; higher values enlarge summary text only. */
