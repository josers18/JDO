 ...
 * with the waffle, global search, notifications, user menu, and Agentforce)
 * comes from the shared `appChrome` config, so it matches the Customer 360
 * exactly. Light-mode commercial theme (copper).
 */
