...
const DASH: HomeDashboard = {
  ...
  callList: [
    { id: 'c1', clientId: '001M', clientName: 'Acme Manufacturing', segment: 'Middle Market', reason: 'PAYDEX 52 (was 68); debt-service coverage trending toward covenant breach', action: 'Covenant review + restructure options', score: 0.90, severity: 'high', source: 'D&B + Covenant', relationshipValue: 42000000 },
    { id: 'c2', clientId: '001N', clientName: 'Northwind Logistics', segment: 'Middle Market', reason: '$8.4M idle in operating accounts >60 days; no sweep in place', action: 'Treasury sweep + liquidity mgmt', score: 0.83, severity: 'high', source: 'Treasury', relationshipValue: 61000000 },
    { id: 'c3', clientId: '001O', clientName: 'Sterling Foods Group', segment: 'Commercial', reason: 'D&B credit score downgraded one tier after a late-filing signal', action: 'Credit review + covenant check', score: 0.76, severity: 'medium', source: 'D&B Credit', relationshipValue: 28000000 },
    { id: 'c4', clientId: '001Q', clientName: 'Vertex Industrial', segment: 'Commercial', reason: 'Line utilization at 92% for 3 straight months — capacity constraint', action: 'Discuss facility increase', score: 0.68, severity: 'medium', source: 'Utilization', relationshipValue: 35000000 },
    { id: 'c5', clientId: '001T', clientName: 'Cascade Retail Co', segment: 'Small Business', reason: 'Maturity in 45 days; renewal not yet initiated', action: 'Begin renewal + repricing', score: 0.57, severity: 'low', source: 'Maturity', relationshipValue: 12000000 },
  ],
  pipeline: [
