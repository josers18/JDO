...
/**
 * HOME app — the advisor's morning landing page (replaces the standard SF
 * home). Horizon-level density: AI daily brief, who-to-call-and-why, AUM/
 * held-away KPIs, life events, pipeline, advisor goals, schedule, alerts,
 * leads. Advisor-centric, across the whole book. Clicking a client opens
 * their embedded 360.
 */
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: '1rem' }}>
        {data.kpis.map((k, i) => (
          <StatTile
            ...
            trend={k.trend}
            deltaPct={k.deltaPct}
            tone={k.key === 'reviews' ? 'risk' : 'accent'}
          />
        ))}
      </div>
