...
export default function HomeLayout() {
  ...
  const nav: NavItem[] = [
    ...
    { id: 'clients', label: 'Clients', icon: '👥', onClick: () => navigate('/client/001am00000qvjsAAAQ') },
    { id: 'portfolios', label: 'Portfolios', icon: '📈', onClick: () => navigate('/') },
    { id: 'plans', label: 'Plans', icon: '🗂', onClick: () => navigate('/') },
