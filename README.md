...
| [**Snowflake_Cumulus_Common**](Snowflake_Cumulus_Common/README.md) | **Cumulus data pipelines foundation** — shared `V_ACCOUNT_ANCHORS` view, anchor fixture, and Python helpers for the 13 forthcoming Cumulus dataset pipelines (Plans 1–13). DC ingests each per-dataset table via the existing "Snowflake (Federate / Zero Copy)" connector. | [README](Snowflake_Cumulus_Common/README.md) · [AGENTS](Snowflake_Cumulus_Common/AGENTS.md) |
