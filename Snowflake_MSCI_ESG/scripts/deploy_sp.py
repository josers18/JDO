...
step so future datasets can clone the recipe with zero manual SQL editing.

What this script does:
  1. Read the SP body from `procedures/sp_generate_msci_esg_scores.py`.
...
Caveats for the next datasets (Plans 3-13):
...
SP_PY = REPO_ROOT / "procedures" / "sp_generate_msci_esg_scores.py"
...
-- Task:    Plan 2 T6
-- Source:  procedures/sp_generate_msci_esg_scores.py
...
def main() -> int:
    ...
    print(
        ...
        f"\"SHOW PROCEDURES LIKE 'SP_GENERATE_MSCI_ESG_SCORES' "
