...
## Boundaries
- Owns: `DATA_JEDAIS.FINS__PUBLIC.MSCI_ESG_SCORES`, `SP_GENERATE_MSCI_ESG_SCORES`, `TASK_MONTHLY_MSCI_ESG_SCORES`, and the DC Data Stream / DLO / DMO that federates this table.
