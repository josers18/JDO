# Multiframework Recipes (JDO port)

> **JDO note:** This is a verbatim port of [trailheadapps/multiframework-recipes](https://github.com/trailheadapps/multiframework-recipes) brought into the JDO monorepo on 2026-05-29 as a reference implementation for Salesforce Multi-Framework (React-on-Platform). Upstream license is Apache-2.0 (see `LICENSE.md`). No JDO-specific changes have been made yet — treat this directory as a learning sandbox; do **not** deploy it to production orgs (beta restriction).
