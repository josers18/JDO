-- =============================================================================
-- DATA_JEDAIS.FINS__PUBLIC.TASK_WEEKLY_SYNTH_RELATIONSHIP_GRAPH
...
-- Schedule: 0 5 * * 1 UTC
-- Wrapper:  DATA_JEDAIS.FINS__PUBLIC.SP_RETRY_WRAPPER('DATA_JEDAIS.FINS__PUBLIC.SP_GENERATE_SYNTH_RELATIONSHIP_GRAPH()', 2)
...
CREATE OR REPLACE TASK DATA_JEDAIS.FINS__PUBLIC.TASK_WEEKLY_SYNTH_RELATIONSHIP_GRAPH
    WAREHOUSE = MAIN_WH_XS
    SCHEDULE  = 'USING CRON 0 5 * * 1 UTC'
AS
    CALL DATA_JEDAIS.FINS__PUBLIC.SP_RETRY_WRAPPER(
        'DATA_JEDAIS.FINS__PUBLIC.SP_GENERATE_SYNTH_RELATIONSHIP_GRAPH()',
        2
    );

ALTER TASK DATA_JEDAIS.FINS__PUBLIC.TASK_WEEKLY_SYNTH_RELATIONSHIP_GRAPH RESUME;
