-- =============================================================================
-- FINS.PUBLIC.TASK_WEEKLY_GONG_CALL_SENTIMENT
...
-- Schedule: 0 5 * * 1 UTC
-- Wrapper:  FINS.PUBLIC.SP_RETRY_WRAPPER('FINS.PUBLIC.SP_GENERATE_GONG_CALL_SENTIMENT()', 2)
...
CREATE OR REPLACE TASK FINS.PUBLIC.TASK_WEEKLY_GONG_CALL_SENTIMENT
    WAREHOUSE = MAIN_WH_XS
    SCHEDULE  = 'USING CRON 0 5 * * 1 UTC'
AS
    CALL FINS.PUBLIC.SP_RETRY_WRAPPER(
        'FINS.PUBLIC.SP_GENERATE_GONG_CALL_SENTIMENT()',
        2
    );

ALTER TASK FINS.PUBLIC.TASK_WEEKLY_GONG_CALL_SENTIMENT RESUME;
